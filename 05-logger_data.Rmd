...
```{r, logger_gropointfig, echo = FALSE, fig.align='center', fig.cap= "GroPoint Segment Schematic (GroPoint Profile User Manual, Page 6)"}
knitr::include_graphics("figures/gropoint_segments.png")
```

```{r, logger_gropointfig2, echo = FALSE, fig.align='center', fig.cap= "GroPoint Temperature sensor depths. We use GPLP-4 with seven temperature sensors. (GroPoint Profile User Manual, Page 6)"}
...
```{r, logger_prieview_data, echo=FALSE}
datatable(
  head(data, show_rows),
  extensions = "Scroller",
...
```{r, logger_dailyavg_preview, echo=FALSE}
datatable(
...
swat_tmp <- read.table("model_data/cs10_setup/optain-cs10/sta_id1.tmp", skip = 3, header = F, sep = "\t") %>% as_tibble()
```

Data preview:

```{r, logger_previewpcp, echo=FALSE}
datatable(
...
```{r, logger_plotclimbase, echo = F, fig.align='center', fig.cap= "Temperature range and precipitation for CS10"}
...
```{r, logger_plot09, fig.align='center', fig.cap= "Logger 600409"}
...
```{r, logger_plot_10, fig.align='center'}
...
```{r, logger_plot_11, fig.align='center'}
...
```{r, logger_plot_clean_11, echo=FALSE}
# regenerate plot
