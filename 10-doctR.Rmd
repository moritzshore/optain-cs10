...
```
Seems like there are no issues. 

```{r}
print_triggered_mgt(sim_verify = veri_mgt, hru_id = 92)
```
Sooo hows it looking?

```{r}
test <- get_hru_id_by_attribute(veri_mgt, mgt = "a_001f_1_drn_mgt_1731_1")

print_triggered_mgt(sim_verify = veri_mgt, hru_id = test$id[1])
```
You tell me!
