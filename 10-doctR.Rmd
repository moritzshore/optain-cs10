...
-   Large implausibilities in the weather inputs can be identified in
...
-   If the lapse rate option is active (Read more in Additional
...
[**ANSWER**]{.underline}: NO, no eplant ET. [[see issue #48]{.underline}](https://gitlab.nibio.no/moritzshore/swat-cs10/-/issues/48){style="font-size: 11pt;"}
...
[#42](https://gitlab.nibio.no/moritzshore/swat-cs10/-/issues/42),
 Csilla plausible?
...
around [4000 MJ](https://re.jrc.ec.europa.eu/pvg_tools/en/) -- Csilla
do you agree?
...
> We are currently using PM-PET, which could be a problem since we don't
> have RH or Wind. This is being discussed in issue #42
> ([link](https://gitlab.nibio.no/moritzshore/swat-cs10/-/issues/42)).
