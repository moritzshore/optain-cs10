...
```{r, svatools_load_lib, message=FALSE}
...
There has been some discussion in issue [#48](https://gitlab.nibio.no/moritzshore/swat-cs10/-/issues/48)
...
```{r, svatools_getammodep, eval = FALSE}
basin_path <- "model_data/input/shape/cs10_basin.shp"
df <-
  get_atmo_dep(
    basin_path,
...
```{r, svatools_plotatmodep2, fig.align='center', fig.cap="Atmospheric Deposition data grabbed by svatools"}
...
```{r, svatools_addatmodepDB, eval = FALSE}
db_path <- "model_data/cs10_setup/optain-cs10/optain-cs10.sqlite"
