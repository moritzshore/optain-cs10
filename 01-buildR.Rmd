...
> Warning: Cannot find coordinate operations from `EPSG:2583`
["unnamed",EDATUM[""], CS[Cartesian,2], AXIS["(E)", east, ORDER[1],
LENGTHUNIT["unknown", 1]], AXIS["(N)", north, ORDER[2], LENGTHUNIT["unknown",
1]]]' (GDAL error 6) Error: [project] Cannot do this transformation
...
BuildR then generates a table with aggregated elevation, slope, soil for HRU
units.

```{r}
#broken, using old soil.tif
