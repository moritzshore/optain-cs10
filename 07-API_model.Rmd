...
```{r, api_python_install, include = TRUE, eval=FALSE}
# install miniconda 
install_miniconda() 
...
\@ref(pre-processing-crop-rotation) by replacing API with our own custom
...
-   Run SWAT+ for the weather data + scenarios data and use the
    calculated snow melt
