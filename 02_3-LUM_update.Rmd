...
This section covers the modifications made to the landuse file. For some reason
it was written in a tutorial fashion, as if the reader were new to R.
...
For the fields we are going to need the crop rotation info which we created in 
section (!ref)
